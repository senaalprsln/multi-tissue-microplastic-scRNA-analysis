...
print("\n=== Adım 1 (immune alt kümesi): Ham küme numaraları ===")
sc.pl.umap(
    adata_immune,
...
for celltype, genes in immune_only_marker_sets.items():
    ...
    if missing:
        print(f"UYARI - {celltype}: bu genler bulunamadı -> {missing}")
...
print("\nimmune_leiden kümeleri için marker skor ortalamaları:")
...
print("\n=== immune_leiden -> Hücre Tipi eşlemesi ===")
...
print("\nBağışıklık hücre tipi dağılımı:")
print(adata_immune.obs["immune_celltype"].value_counts())

print("\n=== Adım 2 (immune alt kümesi): İsimlendirilmiş hücre tipleri ===")
sc.pl.umap(
    adata_immune,
